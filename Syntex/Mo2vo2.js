...
const topBooksProduct = rawApiData.filter((item)=> item.category === "Books")
.sort((a,b)=> b.rating - a.rating).slice(0,3).map((item)=> {return {name: item.productName}})

console.log(topBooksProduct)